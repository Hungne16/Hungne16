...
const groups = [
  { title: 'Frontend engineering', note: 'Interfaces for the web', color: '#9ec8ff', height: 144,
    tools: [['react', 'React'], ['nextjs', 'Next.js'], ['ts', 'TypeScript'], ['js', 'JavaScript'], ['html', 'HTML'], ['css', 'CSS']] },
  { title: 'UI / UX & design', note: 'From idea to prototype', color: '#d2bcf5', height: 100,
    tools: [['figma', 'Figma'], ['framer', 'Framer']] },
  { title: 'Backend & data', note: 'Behind the interface', color: '#b2dfc5', height: 100,
    tools: [['nodejs', 'Node.js'], ['firebase', 'Firebase'], ['mysql', 'SQL']] },
  { title: 'Version control', note: 'Build, track, collaborate', color: '#edc09d', height: 100,
...
<desc id="desc">Frontend: React, Next.js, TypeScript, JavaScript, HTML, CSS. UI and UX: Figma, Framer. Backend and data: Node.js, Firebase, SQL. Version control: Git, GitHub. Decorative animation does not represent proficiency scores.</desc>
...
<rect x="1" y="1" width="958" height="588" rx="18" fill="url(#bg)" stroke="#303b49"/>
...
${rows.join('')}
<path d="M32 550H928" stroke="#2a3441"/><text x="33" y="574" class="note">From visual ideas to working interfaces.</text>
</svg>`);
